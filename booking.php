...
$sql = mysqli_query($con,"SELECT * from register where reg_id='$uid'");
                                    ...
                                    while ($raw = mysqli_fetch_array($result)){ ?>
                                        ...
                                        <form method="post"  enctype="multipart/form-data" action="">
                                            <div class="products-single fix">
                                                ...
                                                <div class="">
                                                    <h1 style="color: red;" align="center"><?php echo $raw['corsename']; ?></h1>
                                                    
                                                
                                                    <a class="nav-link" id="<?php echo $raw['cstart']; ?>" href="boooking.php?cid=<?php echo $raw['cid']; ?>" role="tab" aria-controls="<?php echo $raw['cid']; ?>" aria-selected="true" align="center">Book course</a>
                                                </div>
                                            </div>
                                            </form>
                                        </div>
